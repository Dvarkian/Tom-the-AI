...
layout = [[sg.Text('Hover mouse to see RGB value, click for white & black text',
          justification='center', text_color='blue', background_color='light green', size=(90, 1), font='Default 10', pad=(0, (0, 20)))]]
...
col_layout = [[sg.Column(layout, size=(1110, 800), scrollable=True)]]

window = sg.Window('Color Viewer', col_layout, font='Any 8', element_padding=(0,0), border_depth=0)
